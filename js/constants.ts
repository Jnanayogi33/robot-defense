...
import type { TowerDef, EnemyType, EnemyTypeExt } from './types';
...
export const TOWER_DEFS: TowerDef[] = [
  ...
  { id:'emp', name:'EMP Tower', cost:75, range:110, damage:5, rate:15, color:'#ff0',
    desc:'Slows all nearby bots', bulletColor:'#ff0', bulletSpeed:6, splash:0, slow:0.4, hitsAir: true },
  { id:'rail', name:'Railgun', cost:150, range:200, damage:60, rate:50, color:'#f60',
    desc:'Long-range piercer', bulletColor:'#f84', bulletSpeed:12, splash:0, pierce:true, hitsAir: true, ignoresArmor: true },
  { id:'tesla', name:'Tesla Coil', cost:120, range:100, damage:15, rate:12, color:'#8ff',
    desc:'Chain lightning x3', bulletColor:'#8ff', bulletSpeed:0, splash:0, chain:3, hitsAir: true },
  ...
  { id:'missile', name:'Missile Battery', cost:175, range:220, damage:45, rate:35, color:'#f92',
    desc:'Homing missiles', bulletColor:'#f92', bulletSpeed:4, splash:40, homing:true, hitsAir: true, ignoresArmor: true },
  { id:'photon', name:'Photon Blaster', cost:65, range:115, damage:14, rate:5, color:'#ff9900',
    desc:'Rapid energy bolts', bulletColor:'#ffc200', bulletSpeed:11, splash:0, hitsAir: true },
...
export const ENEMY_TYPES: EnemyTypeExt[] = [
  { name:'Scout',      hp:30,   speed:1.8,  reward:10,  color:'#f44', size:6  },
  { name:'Soldier',    hp:80,   speed:1.2,  reward:20,  color:'#fa0', size:8  },
  { name:'Tank',       hp:200,  speed:0.7,  reward:40,  color:'#a44', size:11, armored: true },
  { name:'Drone',      hp:50,   speed:2.5,  reward:15,  color:'#4af', size:5,  flying: true },
  { name:'Mech',       hp:500,  speed:0.5,  reward:80,  color:'#f4f', size:18 },
  { name:'Swarm',      hp:20,   speed:2.2,  reward:5,   color:'#4f4', size:4  },
  { name:'Titan',      hp:1500, speed:0.35, reward:200, color:'#fff', size:22, armored: true },
  { name:'Juggernaut', hp:6000, speed:0.18, reward:600, color:'#ff2244', size:30, armored: true },
